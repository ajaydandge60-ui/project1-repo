-- encounter_summary
CREATE TABLE IF NOT EXISTS `evident-factor-479408-a9.gold_dataset.encounter_summary` (
    DepartmentID STRING,
...
TRUNCATE TABLE `evident-factor-479408-a9.gold_dataset.encounter_summary`;

INSERT INTO `evident-factor-479408-a9.gold_dataset.encounter_summary`
SELECT
...
CREATE TABLE IF NOT EXISTS `evident-factor-479408-a9.gold_dataset.provider_performance_summary` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
TRUNCATE TABLE `evident-factor-479408-a9.gold_dataset.provider_performance_summary`;

INSERT INTO `evident-factor-479408-a9.gold_dataset.provider_performance_summary`
SELECT
  p.ProviderID,
  p.FirstName,
  p.LastName,
...
-----------------------------
CREATE TABLE IF NOT EXISTS `evident-factor-479408-a9.gold_dataset.patient_billing_summary` (
    PatientID STRING,
    TotalEncounters INT,
    TotalBilled FLOAT64,
    TotalPaid FLOAT64,
...
TRUNCATE TABLE `evident-factor-479408-a9.gold_dataset.patient_billing_summary`;

INSERT INTO `evident-factor-479408-a9.gold_dataset.patient_billing_summary`
SELECT
  t.PatientID,
...
CREATE TABLE IF NOT EXISTS `evident-factor-479408-a9.gold_dataset.claims_summary_by_status_payor` (
    claim_status STRING,
    payor_type STRING,
    Year INT,
    TotalClaims INT,
...
TRUNCATE TABLE `evident-factor-479408-a9.gold_dataset.claims_summary_by_status_payor`;

INSERT INTO `evident-factor-479408-a9.gold_dataset.claims_summary_by_status_payor`
SELECT
  c.claim_status,
  c.payor_type,

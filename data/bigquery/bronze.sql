...
OPTIONS (
  format = 'JSON',
  uris = ['gs://healthcare_b1
/landing/hospital/departments/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://healthcare_b1
/landing/hospital/encounters/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://healthcare_b1
/landing/hospital/patients/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://healthcare_b1
/landing/hospital/providers/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://healthcare_b1
/landing/hospital/transactions/*.json']
);